...
public class KentangState extends ParentState implements MouseListener,MouseMotionListener, KeyListener {
    Thread gameloop;
    GridMap map;
    JPopupMenu popup;
    int startx;
    ...
    public KentangState(int gridRow, int gridColumn) {
...
//        add(time);
    ...
    public void init() {
        ...
        nanaso = new PulmosisLand(map,this,g2d,PulmosisBattle.Kentang);
        nanaso.getCreature().setPosition(new Point2D(2*Utilities.GRIDSIZE,5*Utilities.GRIDSIZE));
        nanaso.getCreature().setFinalPosition(2*Utilities.GRIDSIZE,5*Utilities.GRIDSIZE);
        Point2D pos = nanaso.getCreature().position();
        map.push(pos.X(), pos.Y(), nanaso);
        pos = new Point2D(3*Utilities.GRIDSIZE,5*Utilities.GRIDSIZE);
        nanaso.getCreature().setArah(pos);
        player = new Player(map,this,g2d);
        player.getCreature().setPosition(new Point2D(3*Utilities.GRIDSIZE,5*Utilities.GRIDSIZE));
        player.getCreature().setFinalPosition(3*Utilities.GRIDSIZE,5*Utilities.GRIDSIZE);
        pos = player.getCreature().position();
        map.push(pos.X(), pos.Y(), player);
        pos = new Point2D(2*Utilities.GRIDSIZE,5*Utilities.GRIDSIZE);
...
public void updated(){
    ...
    public JPanel boces (int i) {
        ...
        if (i == 1) {
            ...
            panelis.add(label2);
            label3 = new JLabel ("Help me help me help me");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,0,450,90);
            panelis.add(label3);
            label3 = new JLabel ("My land was attacked ");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,16,450,90);
            panelis.add(label3);
            label3 = new JLabel ("Pleeeeaaasssssseeee help me");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            ...
            label2.setBounds(400,7,150,30);
            panelis.add(label2);
            label3 = new JLabel ("Hhhhheeeeeeeelllllllpppppppp");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,0,450,90);
            panelis.add(label3);
            ...
            label2.setBounds(400,7,150,30);
            panelis.add(label2);
            label3 = new JLabel ("Ohhh,, Thank you sir..");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,0,450,90);
            panelis.add(label3);
            label3 = new JLabel ("My name is Pottatoes");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,16,450,90);
            panelis.add(label3);
            ...
            label2.setBounds(400,7,150,30);
            panelis.add(label2);
            label3 = new JLabel ("Can you beat him for me??");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,0,450,90);
            panelis.add(label3);
            label3 = new JLabel ("I will join your force for helping you");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,16,450,90);
            panelis.add(label3);
            but1 = new JButton ("Next");
            ...
            label2.setBounds(400,7,150,30);
            panelis.add(label2);
            label3 = new JLabel ("Thank you so much sir");
            label3.setFont(new Font("Times New Roman", Font.BOLD, 16));
            label3.setBounds(101,0,450,90);
            panelis.add(label3);
