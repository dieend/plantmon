...
public class Labu extends Plant{
    ...
    @Override public void setPanen(){
        Game.instance().getInventory().add(new FoodItem(Item.BuLabu, null),1);
        super.setPanen();
    }
    public static void main(String[] str){
        JFrame frame=new JFrame();
        BufferedImage bf = new BufferedImage(1, 1, BufferedImage.TYPE_INT_ARGB);
        Labu a = new Labu(new GridMap(), new JPanel(), bf.createGraphics(), 0,0,1);
