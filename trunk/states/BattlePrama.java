...
public class BattlePrama extends ParentState implements MouseListener,MouseMotionListener {
    Thread gameloop;
    GridMap map;
    JPopupMenu popup;
    ...
    boolean dragged;
    Object[] pulmos;
    public BattlePrama(int gridRow, int gridColumn, Object[] args){
        super(gridRow, gridColumn);
        this.pulmos = args;
        ID = BATTLEGURUN;
        init();
        Game.instance().playMusic("002-Battle02.mid");
        time = new JTextArea();
...
//        add(new Component() {});
    ...
    protected void init() {
        ...
        if (pulmos != null) {
            ...
            PulmosisBattle player2 = new PulmosisBattle(map,this, g2d,-7,true,player1.level);
            ...
            PulmosisBattle player5 = new PulmosisBattle(map,this, g2d,-6,true,player1.level);
            ...
            PulmosisBattle player6 = new PulmosisBattle(map,this, g2d,-3,true,player1.level);
...
//                            pul.resetChargeMeter();
        ...
        if (found) {
            ...
            Game.instance().getStory().setWinBattle(true, 1);
